...
function SinglePricingCard() {
  return (
    <Paper className="flex flex-col lg:flex-row max-w-sm lg:max-w-xl">
      <div className="p-24 sm:p-32 lg:p-40">
        <Typography className="text-3xl font-bold">Lifetime Membership</Typography>

        <Typography className="mt-8 leading-relaxed" color="textSecondary">
      ...
      >
        <div className="flex items-center whitespace-nowrap">
          ...
          <Typography className="ml-2 text-2xl font-semibold" color="textSecondary">
            USD
          </Typography>
        </div>
        <Typography className="font-medium text-center" color="textSecondary">

  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between py-32 px-24 md:px-32">
      <Typography
        ...
        delay={300}
        className="hidden sm:flex text-24 md:text-32 font-extrabold tracking-tight"
      >
        Orders
      </Typography>
      ...
      <div className="flex flex-1 items-center justify-end space-x-8">
        <Paper
          ...
          className="flex items-center w-full max-w-256 space-x-8 px-16 rounded-full border-1 shadow-0"
        >

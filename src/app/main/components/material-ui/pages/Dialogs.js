...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/dialogs/CustomizedDialogs.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/dialogs/CustomizedDialogs.js')}
                    /></Typography>
...
<Typography className="mb-16" component="div">Follow the <a href="/utils/modal/#accessibility">Modal accessibility section</a>.</Typography>

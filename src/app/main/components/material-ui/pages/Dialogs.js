...
<Typography className="mb-16" component="div"><span role="img" aria-label="unicode-symbol">⚠</span> While the material design specification encourages theming, this example is off the beaten path.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
...
<Typography className="mb-16" component="div">You may make a dialog responsively full screen the dialog using <code>withMobileDialog</code>. By default, <code>withMobileDialog()(Dialog)</code> responsively full screens <em>at or below</em> the <code>sm</code> <a href="/layout/basics/">screen size</a>. You can choose your own breakpoint for example <code>xs</code> by passing the <code>breakpoint</code> argument: <code>withMobileDialog({"{breakpoint: 'xs'}"})(Dialog)</code>.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
...
<Typography className="mb-16" component="div">Be sure to add <code>aria-labelledby=&quot;id...&quot;</code>, referencing the modal title, to the <code>Dialog</code>. Additionally, you may give a description of your modal dialog with the <code>aria-describedby=&quot;id...&quot;</code> property on the <code>Dialog</code>.</Typography>

...
but you are not confident jumping in, here is an example of how you can customize the component.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/expansion-panels/CustomizedExpansionPanels.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/expansion-panels/CustomizedExpansionPanels.js')}
                    /></Typography>

...
<blockquote>
<Typography className="mb-16" component="div"><strong>Note:</strong> Expansion panels are no longer documented in the Material Design documentation.</Typography>
</blockquote>
...
here is one example of how you can customize the background color of the <code>ExpansionPanelSummary</code> and padding of <code>ExpansionPanelDetails</code>.</Typography>

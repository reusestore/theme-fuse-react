...
<Typography className="mb-16" component="div">In the following example, we demonstrate how to use <a href="https://github.com/bvaughn/react-virtualized">react-virtualized</a> with the <code>Table</code> component. It renders 200 rows and can easily handle more.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
...
<li><a href="https://github.com/mbrn/material-table">material-table</a> DataTable based on table component with additional features like search, filtering, sorting and much more.</li>

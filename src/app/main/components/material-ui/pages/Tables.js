...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/tables/DenseTable.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tables/DenseTable.js')}
                    /></Typography>
...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/tables/CustomizedTables.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tables/CustomizedTables.js')}
                    /></Typography>
...
<Typography className="mb-16" component="div"><img src="https://img.shields.io/github/stars/mbrn/material-table.svg?style=social&label=Stars" alt="stars"/>
<img src="https://img.shields.io/npm/dm/material-table.svg" alt="npm downloads"/></Typography>
...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/tables/MaterialTableDemo.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tables/MaterialTableDemo.js')}
                    /></Typography>
<Typography className="text-24 mt-32 mb-8" component="h3">Other</Typography>
<ul>
<li><a href="https://devexpress.github.io/devextreme-reactive/react/grid/">dx-react-grid-material-ui</a> A data grid for Material-UI with paging, sorting, filtering, grouping and editing features (<a href="https://js.devexpress.com/licensing/">custom license</a>).</li>

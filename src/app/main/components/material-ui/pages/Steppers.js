...
<Typography className="mb-16" component="div">We&#39;ve used the <code>StepButton</code> here to demonstrate clickable step labels as well as setting the <code>completed</code>
...
<Typography className="mb-16" component="div">Labels can be placed below the step icon by setting the <code>alternativeLabel</code> property on the <code>Stepper</code> component.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
...
<Typography className="mb-16" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-32 mb-8" component="h2">Customized Steppers</Typography>
...
<Typography className="mb-16" component="div">This component uses a customized <code>StepConnector</code> element that changes border color based on the <code>active</code> and <code>completed</code> state.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('app/main/components/material-ui/material-ui-examples/steppers/CustomizedSteppers.js').default} 
                    raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/steppers/CustomizedSteppers.js')}
                    /></Typography>

            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    ...
                    <Button
                        ...
                        variant="contained"
                        component="a"
                        href="https://material-ui-next.com/demos/checkboxes"
                        target="_blank"
                    >
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/checkboxes/Checkboxes.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/checkboxes/Checkboxes.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/checkboxes/CheckboxLabels.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/checkboxes/CheckboxLabels.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/checkboxes/CheckboxesGroup.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/checkboxes/CheckboxesGroup.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/checkboxes/FormControlLabelPosition.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/checkboxes/FormControlLabelPosition.js')}
                    /></Typography>

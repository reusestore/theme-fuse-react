            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={true}
                        component={require('app/main/components/material-ui/material-ui-examples/app-bar/HideAppBar.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/app-bar/HideAppBar.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={true}
                        component={require('app/main/components/material-ui/material-ui-examples/app-bar/ElevateAppBar.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/app-bar/ElevateAppBar.js')}
                    /></Typography>
                    ...
                    <ol>
                        <li><Typography className="mb-16" component="div"><code>options</code> (<em>Object</em> [optional]):</Typography>
                            <ul>
                                <li><code>options.disableHysteresis</code> (<em>Boolan</em> [optional]): Defaults to <code>false</code>. Disable the hysteresis. Ignore the scroll
                                    direction when determining the <code>trigger</code> value.
                                </li>
                                <li><code>options.target</code> (<em>Node</em> [optional]): Defaults to <code>window</code>.</li>
                                <li><code>options.threshold</code> (<em>Number</em> [optional]): Defaults to <code>100</code>. Change the <code>trigger</code> value when the
                                    vertical scroll crosses this threshold.
                                </li>
                            </ul>
                        </li>
                    </ol>

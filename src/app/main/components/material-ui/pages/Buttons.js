        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div"><span role="img" aria-label="unicode-symbol">👑</span> If you are looking for inspiration, you can check <a
                        href="https://mui-treasury.com/components/button">MUI Treasury&#39;s customization examples</a>.</Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/buttons/ButtonRouter.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/buttons/ButtonRouter.js')}
                    /></Typography>

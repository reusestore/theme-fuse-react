...
<Typography className="mb-16" component="div">In the following example, we demonstrate how to use <a href="https://github.com/iamhosseindhv/notistack">notistack</a>. notistack makes it easy to display snackbars (so you don&#39;t have to deal with open/close state of them). It also enables you to stack them on top of one another.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}

            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16 p-16 border-1 bg-yellow-50 rounded-8 text-gray-800" component="p">
                        Since not everybody need multi-language setup for their apps,
                        we decided NOT to put translations everywhere.
                        If you want to see the translations in action, visit Mail app and then change the language from the Toolbar.
                    ...
                    <Typography className="mb-8" variant="h5">Usage</Typography>

                    <Typography className="mb-16" component="p">
                        In order to use the translations,
                        create your translation file within the folder you want to use the translations.
                        For example, for the Mail app, create <code>i18n/en.js</code> file inside the <code>apps/mail</code> folder.
                    </Typography>
                    ...
                    <Typography className="mb-16" component="p">
                        And register the language file with <code>i18next.addResourceBundle()</code> at <code>src/app/main/apps/mail/MailAppConfig.js</code>
                    </Typography>
                    ...
                    <Typography className="mb-8" variant="h5">Changing Language</Typography>

            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">Too many type sizes and styles at once can spoil any layout.
                        A <a href="https://material.io/design/typography/#type-scale">typographic scale</a> has a limited set of type sizes that work well together along with the layout
                        grid.</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">In some situations you might not be able to use the <code>{`Typography`}</code> component.
                        Hopefully, you might be able to take advantage of the <a href="/customization/default-theme/?expand-path=$.typography"><code>{`typography`}</code></a> keys of the
                        theme.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
...
`}
                    ...
                    <ul>
                        ...
                        <li><strong>Heading hierarchy</strong>. <a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">Don&#39;t skip</a> heading levels. In order to solve this problem,
                            you need to <a href="#changing-the-semantic-element">separate the semantics from the style</a>.
                        </li>
                    </ul>

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <ol>
                        <li>The value for the textbox must be chosen from a predefined set of allowed values, e.g., a location field must contain a valid location name: <a href="#combo-box">combo
                            box</a>.
                        </li>
                        <li>The textbox may contain any arbitrary value, but it is advantageous to suggest possible values to the user, e.g., a search field may suggest similar or previous searches to
...
`}
                    ...
                    */}
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">Head to the <a href="#customized-hook">Customized hook</a> section for a customization example with
                        the <code>{`useAutocomplete`}</code> hook instead of the component.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Highlights</Typography>
                    <Typography className="mb-16" component="div">The following demo relies on <a href="https://github.com/moroshko/autosuggest-highlight">autosuggest-highlight</a>, a small (1 kB)
                        utility for highlighting text in autosuggest and autocomplete components.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        ...
                        <li><code>{`config`}</code> (<em>Object</em> [optional]):
                            <ul>
                                ...
                                <li><code>{`config.limit`}</code> (<em>Number</em> [optional]): Default to null. Limit the number of suggested options to be shown. For example,
                                    if <code>{`config.limit`}</code> is <code>{`100`}</code>, only the first <code>{`100`}</code> matching options are shown. It can be useful if a lot of options match
...
`}
                    ...
                    <Typography className="mb-16" component="div">By default, the component disable the <strong>autocomplete</strong> feature (remembering what the user has typed for a given field in
                        a previous session) with the <code>{`autoComplete="off"`}</code> attribute.</Typography>
                    <Typography className="mb-16" component="div">However, in addition to remembering past entered values, the browser might also propose <strong>autofill</strong> suggestions (saved
                        login, address, or payment details).
...
`}
                    ...
                    <Typography className="mb-16" component="div">(WAI-ARIA: <a
                        href="https://www.w3.org/TR/wai-aria-practices/#combobox">https://www.w3.org/TR/wai-aria-practices/#combobox</a>)</Typography>

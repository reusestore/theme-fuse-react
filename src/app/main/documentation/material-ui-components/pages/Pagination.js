        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">You can specify how many digits to display either side of current page with the <code>{`siblingRange`}</code> prop, and adjacent to
                        the start and end page number with the <code>{`boundaryRange`}</code> prop.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}

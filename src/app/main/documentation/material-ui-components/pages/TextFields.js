        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/design/components/text-fields.html">Text fields</a> allow users to enter text into a UI. They typically
                        appear in forms and dialogs.</Typography>
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div"><strong>Note:</strong> The standard variant of the <code>{`TextField`}</code> is no longer documented in the <a
                        href="https://material.io/">Material Design guidelines</a>
                    ...
                    <Typography className="mb-16" component="div">Standard form attributes are supported e.g. <code>{`required`}</code>, <code>{`disabled`}</code>, <code>{`type`}</code>, etc. as well
                        as a <code>{`helperText`}</code> which is used to give context about a field’s input, such as how the input will be used.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">The <code>{`error`}</code> prop toggles the error state, the <code>{`helperText`}</code> prop can then be used to provide feedback to
                        the user about the error.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">The <code>{`select`}</code> prop makes the text field use the <a href="/components/selects/">Select</a> component
...
`}
                    ...
                    <Typography className="mb-16" component="div">In order for the text field to be accessible, <strong>the input should be linked to the label and the helper text</strong>. The
                        underlying DOM nodes should have this structure:</Typography>
...
`}
                    ...
                    <ul>
                        <li><a href="https://github.com/stackworx/formik-material-ui">formik-material-ui</a> Bindings for using Material-UI with <a href="https://jaredpalmer.com/formik">formik</a>.
                        </li>
                        <li><a href="https://github.com/erikras/redux-form-material-ui">redux-form-material-ui</a> Bindings for using Material-UI with <a href="https://redux-form.com/">Redux Form</a>.
                        </li>

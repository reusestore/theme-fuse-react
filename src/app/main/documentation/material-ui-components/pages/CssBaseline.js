            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    ...
                    <Button 
                        ...
                        variant="contained" 
                        component="a" 
                        href="https://material-ui-next.com/components/css-baseline" 
                        target="_blank"
                        >
...
It&#39;s using <a href="/customization/default-theme/?expend-path=$.palette.background"><code>{`theme.palette.background.default`}</code></a> for standard devices and a white background for print devices.</li>
</ul>

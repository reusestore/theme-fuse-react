        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/design/components/buttons.html">Buttons</a> communicate actions that users can take. They are typically
                        placed throughout your UI, in places like:</Typography>
                    <ul>
                        <li>Dialogs</li>
                        <li>Modal windows</li>
                        <li>Forms</li>
                    ...
                    <Typography className="mb-16" component="div">Sometimes you might want to have icons for certain button to enhance the UX of the application as we recognize logos more easily than
                        plain text. For example, if you have a delete button you can label it with a dustbin icon.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">The ButtonBase component sets <code>{`pointer-events: none;`}</code> on disabled buttons, which prevents the appearance of a disabled
                        cursor.</Typography>
...
`}
                            ...
                            <ul>
                                <li>You should add <code>{`pointer-events: none;`}</code> back when you need to display <a href="/components/tooltips/#disabled-elements">tooltips on disabled
                                    elements</a>.
                                </li>

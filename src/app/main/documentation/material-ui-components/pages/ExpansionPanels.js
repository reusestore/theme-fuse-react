...
function ExpansionPanelsDoc(props)
{
    ...
    return (
        ...
        <>
            ...
            <Typography className="mb-16" component="div"><a href="https://material.io/archive/guidelines/components/expansion-panels.html">An expansion panel</a> is a lightweight container that may
                either stand alone or be connected to a larger surface, such as a card.</Typography>
            <blockquote>
                <Typography className="mb-16" component="div"><strong>Note:</strong> Expansion panels are no longer documented in the <a href="https://material.io/">Material Design guidelines</a>, but
            ...
            <Typography className="mb-16" component="div">In order to put an action such as a <code>{`Checkbox`}</code> or a button inside of the <code>{`ExpansionPanelSummary`}</code>, you need to
                stop the propagation of the focus and click events to prevent the panel from

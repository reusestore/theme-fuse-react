        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/design/components/lists.html">Lists</a> are a continuous group of text or images. They are composed of
                        items containing primary and supplemental actions, which are represented by icons and text.</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">This feature relies on CSS sticky positioning.
                        Unfortunately it&#39;s <a href="https://caniuse.com/#search=sticky">not implemented</a> by all the supported browsers. It defaults to <code>{`disableSticky`}</code> when not

...
`}
                    ...
                    <Typography className="mb-16" component="div">If you are using server-side rendering, you can set <code>{`implementation="css"`}</code> if you don&#39;t want the browser to re-flow
                        your content on the screen.</Typography>
                    ...
                    <Typography className="mb-16" component="div">It is quite common to alter <code>{`Grid`}</code> at different responsive breakpoints, and in many cases, you want to hide some of
                        those elements.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}

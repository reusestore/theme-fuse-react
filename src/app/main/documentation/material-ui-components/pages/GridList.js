        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/design/components/image-lists.html">Grid lists</a> represent a collection of items in a repeated pattern.
                        They help improve the visual comprehension of the content they hold.</Typography>
                    ...
                    <Typography className="mb-16" component="div">This example demonstrates &quot;featured&quot; tiles, using the <code>{`rows`}</code> and <code>{`cols`}</code> props to adjust the
                        size of the tile, and the <code>{`padding`}</code> prop to adjust the spacing.

            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    ...
                    <Button 
                        ...
                        variant="contained" 
                        component="a" 
                        href="https://material-ui-next.com/components/portal" 
                        target="_blank"
                        >
...
<Typography className="mb-16" component="div">The component is used internally by the <a href="/utils/modal/"><code>{`Modal`}</code></a> and <a href="/utils/popper/"><code>{`Popper`}</code></a> components.

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">The component is used internally by the <a href="/utils/modal/"><code>{`Modal`}</code></a> and <a
                        href="/utils/popper/"><code>{`Popper`}</code></a> components.

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/design/components/data-tables.html">Tables</a> display information in a way that’s easy to scan, so that
                        users can look for patterns and insights. They can be embedded in primary content, such as cards.</Typography>
                    ...
                    <Typography className="mb-16" component="div">The Table has been given a fixed width to demonstrate horizontal scrolling. In order to prevent the pagination controls from
                        scrolling, the TablePagination component is used outside of the Table. (The <a href="#custom-pagination-actions">&#39;Custom Table Pagination Action&#39; example</a> below
                        shows the pagination within the TableFooter.)</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">It&#39;s possible to customise the options shown in the &quot;Rows per page&quot; select using
                        the <code>{`rowsPerPageOptions`}</code> prop.
...
`}
                        ...
                        <li><Typography className="mb-16" component="div"><strong>objects</strong>, the <code>{`value`}</code> and <code>{`label`}</code> keys will be used respectively for the value
                            and label of the option (useful for language strings such as &#39;All&#39;).</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div"><a href="https://github.com/mbrn/material-table">material-table</a> is a simple and powerful Datatable for React based on Material-UI
                        Table with some additional features.
                    ...
                    <ul>
                        <li><a href="https://devexpress.github.io/devextreme-reactive/react/grid/">dx-react-grid-material-ui</a>: A data grid for Material-UI with paging, sorting, filtering, grouping
                            and editing features (<a href="https://js.devexpress.com/licensing/">paid license</a>).
                        </li>
                        ...
                        <li><a href="https://github.com/unosquare/tubular-react">tubular-react</a>: A Material-UI table with local or remote data-source. Featuring filtering, sorting, free-text
                            search, export to CSV locally, and aggregations.
                        </li>
                    </ul>
                    ...
                    <Typography className="mb-16" component="div">A caption functions like a heading for a table. Most screen readers announce the content of captions. Captions help users to find a
                        table and understand what it’s about and decide if they want to read it.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}

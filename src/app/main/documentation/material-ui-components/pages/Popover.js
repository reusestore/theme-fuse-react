            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    ...
                    <Button 
                        ...
                        variant="contained" 
                        component="a" 
                        href="https://material-ui-next.com/components/popover" 
                        target="_blank"
                        >
...
<Typography className="mb-16" component="div">We demonstrate how to use the <code>{`Popover`}</code> component to implement a popover behavior based on the mouse over event.</Typography>
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}

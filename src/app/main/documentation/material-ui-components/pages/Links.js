            ...
            header={
                <div className="flex flex-1 items-center justify-between p-24">
                    ...
                    <Button 
                        ...
                        variant="contained" 
                        component="a" 
                        href="https://material-ui-next.com/components/links" 
                        target="_blank"
                        >
...
<ul>
<li><code>{`rel=&quot;noopener&quot;`}</code> prevents the new page from being able to access the window.opener property and ensures it runs in a separate process.

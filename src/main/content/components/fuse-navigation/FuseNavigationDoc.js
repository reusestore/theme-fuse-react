                ...
                content={
                    <div className="p-24 max-w-2xl mx-auto">
                        ...
                        <Typography className="mb-16" component="p">
                            <code className="language-cmd">FuseNavigation</code> is a custom built Fuse component allows you to create a multi-level collapsable navigation.
                        </Typography>
                        ...
                        <Typography className="mb-16" component="p">
                            <code className="language-cmd">FuseNavigation</code> uses a array to populate the entire navigation. It supports four different navigation items; Group,

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/pickers.html">Pickers</a> provide a simple way to select a
                        single value from a pre-determined set.</Typography>
                    <ul>

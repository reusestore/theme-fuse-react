        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    <Typography className="text-44 mt-32 mb-8" component="h1">Pickers</Typography><Typography className="mb-16" component="p"><a
                    href="https://material.io/guidelines/components/pickers.html">Pickers</a> provide a simple way to select a single value from a pre-determined set.</Typography>
                    <ul>
                    ...
                    <Typography className="text-16 mt-32 mb-8" component="h4">Notice</Typography><Typography className="mb-16" component="p">We are currently falling back
                    to <strong>native input controls</strong>.

         ...
         <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                     <Typography className="text-44 mt-32 mb-8" component="h1">Pickers</Typography><Typography className="mb-16" component="p"><a href="https://material.io/guidelines/components/pickers.html">Pickers</a> provide a simple way to select a single value from a pre-determined set.</Typography><ul>
...
<Typography className="text-16 mt-32 mb-8" component="h4">Notice</Typography><Typography className="mb-16" component="p">We are currently falling back to <strong>native input controls</strong>.
If you are interested in implementing or have implemented a rich Material Design Picker with an awesome UX, please, let us know on <a href="https://github.com/mui-org/material-ui/issues/4787">#4787</a> and <a href="https://github.com/mui-org/material-ui/issues/4796">#4796</a>! We could add a link to or a demo of your project in the documentation.
Here are some components that are promising:</Typography><ul>
...
<Typography className="text-32 mt-32 mb-8" component="h2">Time pickers</Typography><FuseExample
                    className="my-24"
...
<Typography className="text-32 mt-32 mb-8" component="h2">Date &amp; Time pickers</Typography><FuseExample
                    className="my-24"

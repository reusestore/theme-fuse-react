            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        between groups of content that are related and at the same level of hierarchy.</Typography>
                    ...
                    <Typography className="mb-16" component="div">Long labels will automatically wrap on tabs. If the
                        label is too long for the tab, it will overflow and the text will not be visible.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Fixed tabs should be used with a limited number of
                        tabs and when consistent placement will aid muscle memory.</Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Full width</Typography>
                    <Typography className="mb-16" component="div">The <code>fullWidth</code> property should be used for
                        smaller views.
                        This demo also uses <a
                            href="https://github.com/oliviertassinari/react-swipeable-views">react-swipeable-views</a> to
                        animate the Tab transition, and allowing tabs to be swiped on touch devices.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">The <code>centered</code> property should be used for
                        larger views.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Left and right scroll buttons will automatically be
                        presented on desktop and hidden on mobile. (based on viewport width)</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Left and right scroll buttons will never be presented.
                        All scrolling must be initiated through user agent scrolling mechanisms (e.g. left/right swipe,
                        shift-mousewheel, etc.)</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">If you have read the <a
                        href="/customization/overrides">overrides documentation page</a>
                        but aren&#39;t confident jumping in, here&#39;s an example of how you can change the main color
                        of the Tabs. The following demo matches the <a href="https://ant.design/components/tabs/">Ant
                            Design UI</a>.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/tabs.html">Tabs</a> make it easy to explore and switch between
                        different views.</Typography>
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Disabled Tab</Typography>
                    <Typography className="mb-16" component="div">Tab may be disabled by setting <code>disabled</code> property.</Typography>
                    <FuseExample
                        className="my-24"

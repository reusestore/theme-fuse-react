...
<Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/tabs.html">Tabs</a> make it easy to explore and switch between different views.</Typography>
...
but aren&#39;t confident jumping in, here&#39;s an example of how you can change the main color of the Tabs. The following demo matches the <a href="https://ant.design/components/tabs/">Ant Design UI</a>.</Typography>
<FuseExample
                    className="my-24"

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="description">Selection controls allow the user to select
                        options.</Typography>

                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/selection-controls.html">Selection
                        controls</a> allow users to complete tasks that involve making choices such as selecting
                        options, or switching settings on or off. Selection controls are found on screens that ask users
                        to make decisions or declare preferences such as settings or dialogs.</Typography>
                    <Typography className="mb-16" component="div">Three types of selection controls are covered in this
                        section:</Typography>
                    <ul>
                        <li><strong><a href="#checkboxes">Checkboxes</a></strong> allow the selection of multiple
                            options from a set.
                        </li>
                        <li><strong><a href="#radio-buttons">Radio Buttons</a></strong> allow the selection of a single
                            option from a set.
                        </li>
                        <li><strong><a href="#switches">Switches</a></strong> allow a selection to be turned on or off.
                        </li>
                    </ul>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Checkboxes</Typography>
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/selection-controls.html#checkboxes">Checkboxes</a>
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div"><code>Checkbox</code> can also be used with a label
                        description thanks to the <code>FormControlLabel</code> component.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div"><code>FormGroup</code> is a helpful wrapper used to
                        group selection controls components that provides an easier API.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div"><code>RadioGroup</code> is a helpful wrapper used to
                        group <code>Radio</code> components that provides an easier API, and proper keyboard
                        accessibility to the group.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/selection-controls.html#switches">Switches</a>
                        toggle the state of a single setting on or off.
                        They are the preferred way to adjust settings on mobile.</Typography>
                    <Typography className="mb-16" component="div">The option that the switch controls, as well as the
                        state it’s in,
                    ...
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Switches with
                    ...
                    <Typography className="mb-16" component="div"><code>FormGroup</code> is a helpful wrapper used to
                        group selection controls components that provides an easier API.
                    ...
                    <Typography className="mb-16" component="div">If you have been reading the <a
                        href="/customization/overrides">overrides documentation page</a>
                        but you are not confident jumping in, here&#39;s an example of how you can change the color of a
                        Switch, and an iOS style Switch.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"

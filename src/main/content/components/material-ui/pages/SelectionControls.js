        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/selection-controls.html">Selection controls</a> allow the user
                        to select options.</Typography>
                    <Typography className="mb-16" component="div">Three types of selection controls are covered in this guidance:</Typography>
                    <ul>

...
<Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/selection-controls.html">Selection controls</a> allow the user to select options.</Typography>
...
<Typography className="mb-16" component="div">Radio buttons allow the user to select one option from a set. Use radio buttons for exclusive selection if you think that the user needs to see all available options side-by-side;
...
<Typography className="mb-16" component="div">On/off switches toggle the state of a single settings option. The option that the switch controls, as well as the state it’s in, should be made clear from the corresponding inline label.</Typography>
<FuseExample
                    className="my-24"

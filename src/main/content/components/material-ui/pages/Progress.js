        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    <Typography className="text-44 mt-32 mb-8" component="h1">Progress</Typography><Typography className="mb-16" component="p"><a
                    href="https://material.io/guidelines/components/progress-activity.html">Progress and activity indicators</a>
                    are visual indications of an app loading content.</Typography><Typography className="mb-16" component="p">A single visual indicator should be used to represent
                    each type of operation.
                    For example, a refresh operation should display either a refresh bar or an activity circle, but not both.</Typography><Typography className="mb-16"
                                                                                                                                                      component="p"><strong>Determinate</strong> indicators
                    display how long an operation will take.</Typography><Typography className="mb-16" component="p"><strong>Indeterminate</strong> indicators visualize an
                    unspecified wait time.</Typography><Typography className="text-32 mt-32 mb-8" component="h2">Circular</Typography><Typography className="text-24 mt-32 mb-8"
                                                                                                                                                  component="h3">Circular
                    Indeterminate</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Linear</Typography><Typography className="text-24 mt-32 mb-8" component="h3">Linear
                    Indeterminate</Typography><FuseExample
                    className="my-24"

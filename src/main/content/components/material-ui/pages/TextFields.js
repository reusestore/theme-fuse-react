...
<Typography className="mb-16" component="div"><code>TextField</code> is composed of smaller components (<a href="/api/form-control"><code>FormControl</code></a>, <a href="/api/input-label"><code>InputLabel</code></a>, <a href="/api/input"><code>Input</code></a>, and <a href="/api/form-helper-text"><code>FormHelperText</code></a>) that you can leverage directly to significantly customize your form inputs.</Typography>

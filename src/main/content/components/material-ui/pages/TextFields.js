            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        enter text into a UI. They typically appear in forms and dialogs.</Typography>
                    ...
                    <Typography className="mb-16" component="div">The <code>TextField</code> wrapper component is a
                        complete form control including a label, input and help text.</Typography>
                    ...
                    <Typography className="mb-16" component="div"><code>TextField</code> is composed of smaller
                        components (<a href="/api/form-control"><code>FormControl</code></a>, <a
                            href="/api/input-label"><code>InputLabel</code></a>, <a href="/api/input"><code>Input</code></a>,
                        and <a href="/api/form-helper-text"><code>FormHelperText</code></a>) that you can leverage
                        directly to significantly customize your form inputs.</Typography>
                    <Typography className="mb-16" component="div">You might also have noticed that some native HTML
                        input properties are missing from the <code>TextField</code> component.
                        This is on purpose.
                        ...
                        if you want to avoid some boilerplate.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div"><code>TextField</code>, <code>FormControl</code> allow
                        ...
                        whereas <code>dense</code> and <code>normal</code> will as well as alter
                    ...
                    <Typography className="mb-16" component="div">You can use third-party libraries to format an input.
                        ...
                        the <code>inputComponent</code> property.</Typography>
                    ...
                    <Typography className="mb-16" component="div">If you have been reading the <a
                        ...
                        but you are not confident jumping in, here&#39;s an example of how you can change the main color
                        of an Input.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"

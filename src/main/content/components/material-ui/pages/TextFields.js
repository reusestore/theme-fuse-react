        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/text-fields.html">Text fields</a> allow users to input text and
                        usually appear in forms.
                    ...
                    <Typography className="mb-16" component="div">We demonstrate how you could be using third-party libraries to <a
                        href="https://material.io/guidelines/components/text-fields.html#text-fields-input-types">format your input</a>.
                    ...
                    <Typography className="mb-16" component="div">You have been reading our <a href="/customization/overrides">overrides documentation page</a>
                        but you are not confident jumping in?
                        Here is an example of how you can change the main color of an input from &quot;primary&quot; to purple.
                        There is no limit.</Typography>
                    <FuseExample
                        className="my-24"

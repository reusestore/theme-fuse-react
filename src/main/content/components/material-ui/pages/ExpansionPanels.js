        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/expansion-panels.html">Expansion Panels</a> contain creation
                        flows and allow lightweight editing of an element.</Typography>

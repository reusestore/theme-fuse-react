        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/archive/guidelines/components/snackbars-toasts.html">Snackbars</a> provide brief
                        feedback about an operation through a message - typically at the bottom of the screen.</Typography>

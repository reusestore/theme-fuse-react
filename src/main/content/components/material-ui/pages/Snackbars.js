        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="description">Snackbars provide brief messages about app processes through a
                        message - typically at the bottom of the screen</Typography>
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        process that an app has performed or will perform. They appear temporarily, towards the bottom
                        of the screen. They shouldn’t interrupt the user experience, and they don’t require user input
                        to disappear.</Typography>
                    ...
                    <Typography className="mb-16" component="div">Change the direction of the transition. Slide is the
                        default transition.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Don&#39;t block the floating action
                        button</Typography>
                    <Typography className="mb-16" component="div">Move the floating action button vertically to
                        accommodate the snackbar height.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Per <a
                        href="https://material.io/design/components/snackbars.html#snackbars-toasts-usage">Google&#39;s
                        guidelines</a>, when a second snackbar is triggered while the first is displayed, the first
                        should start the contraction motion downwards before the second one animates
                        upwards.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"

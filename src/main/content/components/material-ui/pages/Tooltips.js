        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div">The <a href="https://material.io/guidelines/components/tooltips.html#">tooltips</a> are text labels that appear
                        when the user hovers over, focuses on, or touches an element.</Typography>

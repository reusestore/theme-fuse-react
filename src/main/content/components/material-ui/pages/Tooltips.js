        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    <Typography className="text-44 mt-32 mb-8" component="h1">Tooltips</Typography><Typography className="mb-16" component="p">The <a
                    href="https://material.io/guidelines/components/tooltips.html#">tooltips</a> are text labels that appear when the user hovers over, focuses on, or touches an
                    element.</Typography><Typography className="text-32 mt-32 mb-8" component="h2">Simple Tooltips</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Positioned Tooltips</Typography><Typography className="mb-16"
                                                                                                                          component="p">The <code>Tooltip</code> has 12 placements
                    choice.
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Showing and hiding</Typography><Typography className="mb-16" component="p">The tooltip is normally

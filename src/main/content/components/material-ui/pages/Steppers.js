            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        progress through a sequence of logical and numbered steps. They may also be used for navigation.
                    ...
                    <Typography className="mb-16" component="div">The <code>Stepper</code> can be controlled by passing
                        the current step index (zero-based) as
                    ...
                    <Typography className="mb-16" component="div">This example also shows the use of an optional step by
                        placing the <code>optional</code> property on the second <code>Step</code> component. Note that
                        it&#39;s up to you to manage when an optional step is skipped. Once you&#39;ve determined this
                        for a particular step you must set <code>completed={false}</code> to signify that even though
                        the active step index has gone beyond the optional step, it&#39;s not actually
                        complete.</Typography>
                    ...
                    <Typography className="mb-16" component="div">This example is similar to the regular horizontal
                        stepper, except steps are no longer automatically set to <code>disabled={true}</code> based on
                    ...
                    <Typography className="mb-16" component="div">We&#39;ve used the <code>StepButton</code> here to
                        demonstrate clickable step labels as well as setting the <code>completed</code>
                    ...
                    <Typography className="mb-16" component="div">Labels can be placed below the step icon by setting
                        the <code>alternativeLabel</code> property on the <code>Stepper</code> component.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Use a progress bar when there are many steps, or if
                        there are steps that need to be inserted during the process (based on responses to earlier
                        steps).</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"

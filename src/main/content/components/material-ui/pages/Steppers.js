        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/steppers.html">Steppers</a> convey progress through numbered
                        steps.</Typography>
                    <blockquote>
                        <Typography className="mb-16" component="div">Steppers display progress through a sequence of logical and numbered steps. They may also be used for
                    ...
                    <Typography className="mb-16" component="div">This component implements a compact stepper suitable for a mobile device. See <a
                        href="https://material.io/guidelines/components/steppers.html#steppers-types-of-steps">mobile steps</a> for its inspiration.</Typography>

...
but you are not confident jumping in, here&#39;s an example of how you can change the main color of a Button.</Typography>
<FuseExample
                    className="my-24"
...
<Typography className="mb-16" component="div">The Flat Buttons, Raised Buttons, Floating Action Buttons and Icon Buttons are built on top of the same component: the <code>ButtonBase</code>.
...
`}
                ...
                <Typography className="mb-16" component="div"><em>Note: Creating <code>MyLink</code> is necessary to prevent unexpected unmounting. You can read more about it <a href="/guides/composition#component-property">here</a>.</em></Typography>

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    <Typography className="text-44 mt-32 mb-8" component="h1">Buttons</Typography><Typography className="mb-16" component="p"><a
                    href="https://material.io/guidelines/components/buttons.html">Buttons</a> communicate the action that will occur when the user touches
                    them.</Typography><Typography className="mb-16" component="p">Material buttons trigger an ink reaction on press.
                    They may display text, imagery, or both.
                    Flat buttons and raised buttons are the most commonly used types.</Typography><Typography className="text-32 mt-32 mb-8" component="h2">Flat
                    Buttons</Typography><Typography className="mb-16" component="p">Flat buttons are text-only buttons.
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Raised Buttons</Typography><Typography className="mb-16" component="p">Raised buttons are
                    rectangular-shaped buttons.
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Floating Action Buttons</Typography><Typography className="mb-16" component="p">A floating action
                    ...
                    When pressed, it may contain more related actions.</Typography><Typography className="mb-16" component="p">Only one floating action button is recommended per
                    screen to represent the most common action.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="mb-16" component="p">The floating action button animates onto the screen as an expanding piece of material, by
                        default.</Typography><Typography className="mb-16" component="p">A floating action button that spans multiple lateral screens (such as tabbed screens)
                    should briefly disappear,
                    then reappear if its action changes.</Typography><Typography className="mb-16" component="p">The Zoom transition can be used to achieve this. Note that since
                    both the exiting and entering
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Sizes</Typography><Typography className="mb-16" component="p">Fancy larger or smaller buttons? Use
                    the <code>size</code> or the <code>mini</code> property.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Icon Buttons</Typography><Typography className="mb-16" component="p">Icon buttons are commonly found
                    in app bars and toolbars.</Typography><Typography className="mb-16" component="p">Icons are also appropriate for toggle buttons that allow a single choice to be
                    selected or
                    ...
                    <Typography className="text-24 mt-32 mb-8" component="h3">Buttons with icons and label</Typography><Typography className="mb-16" component="p">Sometimes you
                    might want to have icons for certain button to enhance the UX of the application as we recognize logos more easily than plain text. For example, if you have a
                    delete button you can label it with a dustbin icon.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Complex Buttons</Typography><Typography className="mb-16" component="p">The Flat Buttons, Raised
                    Buttons, Floating Action Buttons and Icon Buttons are built on top of the same component: the <code>ButtonBase</code>.
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Third-party routing library</Typography><Typography className="mb-16" component="p">One common use
                    case is to use the button to trigger a navigation to a new page.

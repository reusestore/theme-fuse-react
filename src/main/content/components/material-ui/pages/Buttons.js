        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/buttons.html">Buttons</a> communicate the action that will
                        occur when the user touches them.</Typography>

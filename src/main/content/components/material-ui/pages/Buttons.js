            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        users can take. They are typically placed throughout your UI, in places like:</Typography>
                    <ul>
                        <li>Dialogs</li>
                        <li>Modal windows</li>
                        <li>Forms</li>
                    ...
                    <Typography className="mb-16" component="div">The Zoom transition can be used to achieve this. Note
                        ...
                        animations are triggered at the same time, we use <code>enterDelay</code> to allow the outgoing
                    ...
                    <Typography className="mb-16" component="div">Fancy larger or smaller buttons? Use
                        the <code>size</code> or the <code>mini</code> property.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">Sometimes you might want to have icons for certain
                        button to enhance the UX of the application as we recognize logos more easily than plain text.
                        For example, if you have a delete button you can label it with a dustbin icon.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                    ...
                    <Typography className="mb-16" component="div">The Text Buttons, Contained Buttons, Floating Action
                        Buttons and Icon Buttons are built on top of the same component: the <code>ButtonBase</code>.
...
`}
                    ...
                    <Typography className="mb-16" component="div">or if you want to avoid properties
                        collisions:</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div"><em>Note: Creating <code>MyLink</code> is necessary to
                        prevent unexpected unmounting. You can read more about it <a

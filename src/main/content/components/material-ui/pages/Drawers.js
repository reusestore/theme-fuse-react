        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    <Typography className="text-44 mt-32 mb-8" component="h1">Drawer</Typography><Typography className="mb-16" component="p">The <a
                    href="https://material.io/guidelines/patterns/navigation-drawer.html">Drawer</a> slides in from the side.
                    It is a common pattern found in Google apps and follows the keylines and metrics for lists.</Typography><Typography className="text-32 mt-32 mb-8"
                                                                                                                                        component="h2">Temporary drawer</Typography><Typography
                    className="mb-16" component="p">Temporary navigation drawers can toggle open or closed. Closed by default, the drawer opens temporarily above all other content
                    until a section is selected.</Typography><Typography className="mb-16" component="p">The Drawer can be cancelled by clicking the overlay or pressing the Esc
                    key.
                    ...
                    className="text-24 mt-32 mb-8" component="h3">Full-height navigation</Typography><Typography className="mb-16" component="p">Apps focused on information
                    consumption that use a left-to-right hierarchy.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-24 mt-32 mb-8" component="h3">Clipped under the app bar</Typography><Typography className="mb-16" component="p">Apps focused on
                    productivity that require balance across the screen.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Persistent drawer</Typography><Typography className="mb-16" component="p">Persistent navigation
                    drawers can toggle open or closed.
                    ...
                    The state of the drawer is remembered from action to action and session to session.</Typography><Typography className="mb-16" component="p">When the drawer is
                    outside of the page grid and opens, the drawer forces other content to change size and adapt to the smaller viewport.</Typography><Typography className="mb-16"
                                                                                                                                                                  component="p">Persistent
                    navigation drawers are acceptable for all sizes larger than mobile.
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Mini variant drawer</Typography><Typography className="mb-16" component="p">In this variation, the
                    ...
                    When expanded, it appears as the standard persistent navigation drawer.</Typography><Typography className="mb-16" component="p">The mini variant is recommended
                    for apps sections that need quick selection access alongside content.</Typography><FuseExample
                    className="my-24"
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">Responsive drawer</Typography><Typography className="mb-16"
                                                                                                                        component="p">The <code>Hidden</code> responsive helper
                    component allows showing different types of drawer depending on the screen width.

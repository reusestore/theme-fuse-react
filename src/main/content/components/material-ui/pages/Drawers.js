...
<Typography className="mb-16" component="div"><a href="https://material.io/design/components/navigation-drawer.html">Navigation drawers</a> provide access to destinations and app functionality, such as switching accounts. They can either be permanently on-screen or controlled by a navigation menu icon.</Typography>
...
<Typography className="mb-16" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-16" component="div">We are using the following set of properties on this documentation website for optimal usability of the component:</Typography>
<ul>
...
with the discovery feature. We have to disable it.</li>
</ul>
...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={true}
                    component={require('main/content/components/material-ui/material-ui-examples/drawers/PersistentDrawerLeft.js').default} 
                    raw={require('!raw-loader!main/content/components/material-ui/material-ui-examples/drawers/PersistentDrawerLeft.js')}
                    />
<FuseExample
                    className="my-24"
                    iframe={true}
                    component={require('main/content/components/material-ui/material-ui-examples/drawers/PersistentDrawerRight.js').default} 
                    raw={require('!raw-loader!main/content/components/material-ui/material-ui-examples/drawers/PersistentDrawerRight.js')}
                    /></Typography>

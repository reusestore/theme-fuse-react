        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/lists.html">Lists</a> present multiple line items vertically as
                        a single continuous element.</Typography>
                    <Typography className="mb-16" component="div">Lists are made up of a continuous column of rows. Each row contains a tile. Primary actions fill the tile, and
                        supplemental actions are represented by icons and text.</Typography>

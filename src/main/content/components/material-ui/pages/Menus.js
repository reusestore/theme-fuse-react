...
<Typography className="mb-16" component="div">A <a href="https://material.io/design/components/menus.html">Menu</a> displays a list of choices on a temporary surface. They appear when users interact with a button, action, or other control.</Typography>
<Typography className="text-32 mt-32 mb-8" component="h2">Simple Menu</Typography>
<Typography className="mb-16" component="div">Simple menus open over the anchor element by default (this option can be changed via props). When close to a screen edge, simple menus vertically realign to make all menu items are completely visible.</Typography>
...
<Typography className="mb-16" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-16" component="div">If text in a simple menu wraps to a second line, use a simple dialog instead. Simple dialogs can have rows with varying heights.</Typography>
...
<Typography className="mb-16" component="div"><FuseExample
                    className="my-24"
                    iframe={false}
                    component={require('main/content/components/material-ui/material-ui-examples/menus/MenuPopupState.js').default} 
                    raw={require('!raw-loader!main/content/components/material-ui/material-ui-examples/menus/MenuPopupState.js')}
                    /></Typography>

        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><a href="https://material.io/guidelines/components/menus.html">Menus</a> display a list of choices on a transient
                        sheet of material.</Typography>
                    <Typography className="mb-16" component="div">Menus appear upon interaction with a button, action, or other control. They display a list of choices, with one
                        choice per line.</Typography>
                    <Typography className="mb-16" component="div">Menu items may be disabled if not applicable to a certain context. Contextual menus dynamically change their
                        available menu items based on the current state of the app.</Typography>
                    ...
                    <Typography className="mb-16" component="div">The <code>Menu</code> component uses the <code>Popover</code> component internally.
                        ...
                        For answering those needs, we expose a <code>MenuList</code> component that you can compose, with <a
                            href="https://github.com/souporserious/react-popper">react-popper</a> in this example.</Typography>
                    ...
                    <Typography className="text-32 mt-32 mb-8" component="h2">ListItem composition</Typography>

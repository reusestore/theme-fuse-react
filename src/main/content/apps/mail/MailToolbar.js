...
class MailToolbar extends Component {
    ...
    render()
    {
        const {classes, selectAllMails, deselectAllMails, selectMailsByParameter, setFolderOnSelectedMails, toggleLabelOnSelectedMails, folders, labels, selectedMailIds} = this.props;
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(MailToolbar));

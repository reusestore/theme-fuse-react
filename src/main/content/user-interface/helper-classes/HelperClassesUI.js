                ...
                content={
                    <div className="p-24 max-w-2xl mx-auto">
                        ...
                        <Typography className="mb-16" component="p">
                            ...
                            <a href="https://material-ui-next.com/customization/css-in-js" target="_blank" rel="noopener noreferrer">Material-UI's styling solution</a> uses JSS at
                            its core.
                        ...
                        <Typography className="mb-16" component="p">
                            We are using <a href="https://tailwindcss.com" target="_blank" rel="noopener noreferrer">Tailwind</a> as an engine for generating helper classes. It's

...
import {Button, Card, CardContent, Divider, FormControl, Grow, Input, InputLabel, Typography} from 'material-ui';
                    ...
                    <Grow in={true}>
                        <Card className={classes.card}>
                            ...
                            <CardContent className="flex flex-col items-center justify-center p-32 text-center">
                                ...
                                <FuseCountdown eventDate="2019-07-28" className="my-48"/>
